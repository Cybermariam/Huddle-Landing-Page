...
//       <h1 className="text-2xl md:text-4xl lg:text-5xl pb-4 text-[#00252e] max-w-sm md:max-w-3xl lg:max-w-6xl">
...
//       </p>
//       <button className="bg-[hsl(322,100%,66%)] cursor-pointer text-white rounded-full p-4 text-sm font-bold mt-10 w-[70%] sm:w-[40%] md:w-[40%] lg:w-[30%] md:text-base lg:text-lg lg:p-6">
